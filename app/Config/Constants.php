...
/*
 ...
 | --------------------------------------------------------------------------
 |
 | This defines the environment the application is running in.
 | This affects things like error reporting, caching, etc.
 */
defined('ENVIRONMENT') || define('ENVIRONMENT', $_ENV['CI_ENVIRONMENT'] ?? 'development');
